...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "about.skillsHeading3": "Soft Skills",
      "about.note": "*This website was built entirely by me using Claude Code.",
      "softskill.strategic.name": "Strategic thinking",
      "softskill.strategic.desc": "Business vision that goes beyond execution.",
      "softskill.dataDriven.name": "Data-driven decision making",
      "softskill.dataDriven.desc": "Applying data rigor to strategic decisions, not just reporting.",
      "softskill.adaptability.name": "Adaptability",
      "softskill.adaptability.desc": "3+ years managing 40+ brands across very different sectors.",
      "softskill.autonomy.name": "Autonomous work",
      "softskill.autonomy.desc": "Running accounts independently, without constant oversight.",
      "softskill.collaboration.name": "Cross-team collaboration",
      "softskill.collaboration.desc": "Coordinating with agencies, internal teams and partners.",
      "softskill.problemSolving.name": "Problem solving under pressure",
      "softskill.problemSolving.desc": "Staying sharp and finding solutions when it matters most.",
      "softskill.communication.name": "Clear communication",
      "softskill.communication.desc": "Client presentations, strategy decks and reporting.",
      "softskill.proactivity.name": "Proactivity",
      "softskill.proactivity.desc": "Automating processes and proposing improvements, unprompted.",
    ...
    es: {
      ...
      "softskill.strategic.name": "Pensamiento estratégico",
      "softskill.strategic.desc": "Visión de negocio por encima de la ejecución.",
      "softskill.dataDriven.name": "Toma de decisiones basada en datos",
      "softskill.dataDriven.desc": "Aplicar el rigor de los datos a las decisiones estratégicas, no solo al reporting.",
      "softskill.adaptability.name": "Adaptabilidad",
      "softskill.adaptability.desc": "3+ años gestionando más de 40 marcas de sectores muy distintos.",
      "softskill.autonomy.name": "Trabajo autónomo",
      "softskill.autonomy.desc": "Gestión de cuentas propias sin supervisión constante.",
      "softskill.collaboration.name": "Colaboración entre equipos",
      "softskill.collaboration.desc": "Coordinación con otras agencias, equipos internos y partners.",
      "softskill.problemSolving.name": "Resolución de problemas bajo presión",
      "softskill.problemSolving.desc": "Mantener la cabeza fría y encontrar soluciones cuando más importa.",
      "softskill.communication.name": "Comunicación clara",
      "softskill.communication.desc": "Presentaciones a cliente, estrategias y reporting.",
      "softskill.proactivity.name": "Proactividad",
      "softskill.proactivity.desc": "Automatizar procesos y proponer mejoras sin que te las pidan.",
