...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "case.manteigaria.desc": "Led the digital strategy from day one for Manteigaria's launch in Spain, building the brand from scratch in a new market, driving the initial launch campaign and supporting 4 subsequent store openings across Madrid.",
      "case.haagen.desc": "Full digital presence management across Spain and Mexico: situational audit of the existing strategy, content and paid media optimization, and end-to-end planning and execution of seasonal campaigns (summer and winter) adapted to each market. Ongoing performance tracking and strategic decision-making throughout the year.",
      "case.legado.desc": "Ongoing strategic involvement in Legado Ibérico, continuous performance tracking and data-driven decision-making alongside campaign-specific work spanning high-profile activations such as Madrid Fashion Week sponsorship, the Spanish National Football Team sponsorship and partnerships with key influencers for campaigns like Javier Castillo, Carmen Lomana or Mario Vaquerizo.",
      ...
      "m.manteigaria.reviews": "reviews",
      "m.manteigaria.rating": "rating",
      "m.manteigaria.reach": "reach",
      "m.manteigaria.impressionsIG": "impressions on Instagram",
      "m.legado.reach": "reach (+305% above target)",
      "m.legado.impressions": "impressions (+372% above target)",
      "m.legado.engagement": "engagement on reach (+595% above target)",
    ...
    es: {
      ...
      "case.manteigaria.desc": "Lideré la estrategia digital desde el primer día para el lanzamiento de Manteigaria en España, construyendo la marca desde cero en un mercado nuevo, impulsando la campaña de lanzamiento inicial y dando soporte a las 4 aperturas de tienda posteriores en Madrid.",
      "case.haagen.desc": "Gestión integral de la presencia digital en España y México: auditoría de la estrategia existente, optimización de contenido y paid media, y planificación y ejecución integral de campañas estacionales (verano e invierno) adaptadas a cada mercado. Seguimiento continuo de resultados y toma de decisiones estratégicas durante todo el año.",
      "case.legado.desc": "Implicación estratégica continua en Legado Ibérico, con seguimiento constante de resultados y toma de decisiones basada en datos, además de trabajo específico en campañas que abarcan activaciones de alto nivel como el patrocinio de Madrid Fashion Week, el patrocinio de la Selección Española de Fútbol y colaboraciones con influencers clave en campañas como las de Javier Castillo, Carmen Lomana o Mario Vaquerizo.",
      ...
      "m.manteigaria.reviews": "reseñas",
      "m.manteigaria.rating": "valoración",
      "m.manteigaria.reach": "alcance",
      "m.manteigaria.impressionsIG": "impresiones en Instagram",
      "m.legado.reach": "alcance (+305% sobre objetivo)",
      "m.legado.impressions": "impresiones (+372% sobre objetivo)",
      "m.legado.engagement": "interacción sobre alcance (+595% sobre objetivo)",
